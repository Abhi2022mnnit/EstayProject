...
function Login() {
  ...
  <div className="flex bg-white rounded-lg shadow-lg border overflow-hidden max-w-sm lg:max-w-4xl w-full">
    <div
      ...
      style={{
        backgroundImage: `url("https://plus.unsplash.com/premium_photo-1681487814165-018814e29155?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTd8fGxvZ2luJTIwcGFnZXxlbnwwfHwwfHx8MA%3D%3D")`,
      }}
    ></div>
